<?php
 ...
 //echo 'Informacion: ' . file_get_contents('php://input');
    ...
    include_once("../../clases/Usuarios/class-promocionesFavoritos.php");//Incluir el archivo
    ...
    switch($_SERVER['REQUEST_METHOD']){
        ...
        case 'POST'://GUARDAR
            ...
            $usuario = new PromocionesFavoritas(
                $_POST["nombre"],
                $_POST["precio"],
                $_POST["porcentaje"],
                $_POST["descripcion"],
           ...
           echo   $usuario->guardarPromocionFavorita($database->getDB(),$_GET["id"]);  
        ...
        case 'GET'://Obtener
            if (isset($_GET['id']) & isset($_GET['index']) ){
              ...
              PromocionesFavoritas::obtenerPromocionFavorita($database->getDB(),$_GET['id'],$_GET['index']);

            }else{

                //Llamar al metodo
                PromocionesFavoritas::obtenerPromocionesFavoritas($database->getDB(),$_GET['id']);
        ...
        case 'DELETE':
            ...
            //llamamos el metodo
            PromocionesFavoritas :: eliminarPromocionFavorita($database->getDB(),$_GET['id'],$_GET["index"]);
