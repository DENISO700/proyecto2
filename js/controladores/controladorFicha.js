...
function obtenerEmpresas() {
    ...
    axios({
        ...
        this.promociones = res.data; //asignamos a el arreglo usuarios los valores de la respuesta
...
function ficha() {
    ...
    if (document.getElementById("productos").value != -1) {
        ...
        var descuento = promociones[document.getElementById("productos").value].porcentaje * 100;
                        ...
                        <div class="container col-md-8 mt-3" style="background-color: darkgray;">
                            ...
                            <div class="row" style="background-color: rgba(177, 27, 27, 0.61);">
                                ...
                                <div class="main col-md-4">
                                    <h2 style="color: black;" style="font-weight: bold;">${promociones[document.getElementById("productos").value].nombre}</h2>
                                    <p style="color: black;" style="font-weight: bold;">${promociones[document.getElementById("productos").value].descripcion}
                                    </p>
                                </div>

                                <div class="main2 col-md-4 mt-4" id="foto">
                                        <img src="${promociones[document.getElementById("productos").value].foto}" width="125" height="125" />
        ...
        `
        P = document.getElementById("productos").value;
